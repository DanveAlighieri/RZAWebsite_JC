...
public partial class TlS2300716RzaContext : DbContext
{
    public TlS2300716RzaContext()
    {
    }

    public TlS2300716RzaContext(DbContextOptions<TlS2300716RzaContext> options)
        : base(options)
    {
    }
